<template>
    <div class="container text-medium">
    	...
    	<FAQContainer>
    		...
    		<template v-slot:body>
    			<p>During the genesis auction starting on 2 November 2019, 9:00 am CET, each day users can bid on the setting of a single given geometric parameter and apply it to a 3D-avatar. The avatar portrays the 3D-scanned female body of a real person. We call her twistedsister.</p>
    		</template>
    	</FAQContainer>
    	...
    	<FAQContainer>
    		...
    		<template v-slot:body>
    			<p>With the end of the genesis auction the appearance of twistedsister is finalized and all tokens will have been distributed. Holding a TWIST token represents a tamperproof certificate of participation in and ownership of a limited-edition artwork. A total of 21 TWIST tokens will be issued. Each token is numbered. TWIST token holders will have the right to access, view and download the jointly modified avatar of twistedsister.</p>
    		</template>
    	</FAQContainer>
